    ...
    try:
        ...
        for i, query in enumerate(queries, 1):
            ...
            try:
                ...
                # 保存状态（示例）
                state_file = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "reports", f"state_task_{i}.json"))
...
def state_management_example():
    ...
    try:
        ...
        query = "35岁中年危机应该如何自救度过？自学GoLang编程是否还有前途？"
        print(f"开始研究: {query}")
        ...
        # 保存状态
        state_file = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "reports", "quantum_computing_state.json"))
        agent.save_state(state_file)
